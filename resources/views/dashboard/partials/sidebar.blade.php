<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        @role('doctor')
            <a href="{{ route('doctor.dashboard') }}" class="app-brand-link"></a>
        @endrole
        @role('admin')
            <a href="{{ route('admin.dashboard') }}" class="app-brand-link"></a>
        @endrole
        @role('patient')
            $routeName = ;
            <a href="{{ route('patient.dashboard') }}" class="app-brand-link"></a>
        @endrole
